...
public class Music : MonoBehaviour
{
    ...
    public class Section
    {
        ...
        public Section(int startBar, int mtBeat = 4, int mtBar = 16, double tempo = 120)
        {
            ...
            UnitPerBeat = mtBeat;
            UnitPerBar = mtBar;
            Tempo = SelectSceneManager.bpm * Music.rate;
        }
    ...
    public static float rate { get { return 1.0f; } }
    ...
    void Awake()
    {
...
#endif
        MusicList_.Add(this);
        musicSource_ = GameObject.FindGameObjectWithTag("Respawn").GetComponent<AudioPlayer>().GetAudioSource();
        ...
        for (int i = 0; i < Sections.Count; ++i)
        {
            Sections[i].Tempo = SelectSceneManager.bpm * Music.rate;
        }
